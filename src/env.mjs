...
export const env = createEnv({
    server: {
        ...
        COURSES_DB_PATH: z.string().optional().or(z.literal('')),
    },
    client: {
        NEXT_PUBLIC_UMAMI_WEBSITE_ID: z.string().optional().or(z.literal('')),
        NEXT_PUBLIC_CONTAINER_KEYCLOAK_ENDPOINT: z.string().optional().or(z.literal('')),
        NEXT_PUBLIC_LOCAL_KEYCLOAK_URL: z.string().optional().or(z.literal('')),
        NEXT_PUBLIC_FEEDBACK_FORM_URL: z.string().optional().or(z.literal('')),
    },
